...
>
  ...
  @if ($role === 'vendor')
    <div class="mb-4">
      <input
        type="text"
        wire:model.debounce.500ms="company"
        class="w-full border @error('company') border-red-500 @enderror"
    ...
    <div class="mb-4">
      <input
        ...
        class="w-full border @error('vat') border-red-500 @enderror"
  ...
  @endif
  <button class="py-2 px-4 bg-indigo-500 hover:bg-indigo-600 rounded text-white">Register</button>
</form>
